...
try:
    ...
    _import_structure["trainer_checkfreq"] = ["CheckFreqTrainer"]
    _import_structure["trainer_gpm"] = ["GPMTrainer"]
    _import_structure["trainer_pccheck"] = ["PCcheckTrainer"]
    _import_structure["trainer_pp"] = ["PPTrainer"]
