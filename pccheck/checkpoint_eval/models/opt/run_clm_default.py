...
# from transformers.src.trainer_chfreq import Trainer
...
class ModelArguments:
    ...
    cfreq: int = field(default=10, metadata={"help": ("Checkpoint frequency")})
    bench_total_steps: int = field(
        default=1000, metadata={"help": ("Total steps (for benchmarking)")}
    )
