...
def main():
    ...
    if args.do_train:
        ...
        # chk = CFCheckpoint(model=model.state_dict(), optimizer=optimizer.state_dict(), model2 = model.state_dict(), opt2=optimizer.state_dict(), model3=model.state_dict(), opt3=optimizer.state_dict(), model4=model.state_dict())
        chk = None
